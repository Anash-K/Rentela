...
const logger = pino({ name: "invoice-dlq" });

let producer = null;

/**
 * Dead-letter topic for poison / repeatedly failing `payment.completed` messages.
 * Alert: log at `error` with `ALERT` prefix for ops / PagerDuty wiring.
 */
